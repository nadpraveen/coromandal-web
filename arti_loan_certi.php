    ...
    <div class="row">
        <div class="col-md-12">
            <div class="wrap">
                ...
                $fetch_loan_data->prepare("SELECT * FROM `th_arti_loan_master` where GL_NO = $user AND LOAN_NO = $loan_number ORDER BY `DATE_OF_SANCTION` DESC");
                ...
                <div class="row">
                    ...
                    <?php
                    $query = "SELECT * FROM `th_arti_loan_trans` where LOAN_NO = $loan_number";
                    //echo $query;
