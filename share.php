...
<div class="container">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <fieldset>
                <legend>Share Capital Info</legend>
                <table class="table table-bordered" id="info_tbl">
                    ...
                    $get_deposit_info->query("select * from th_share_master where GL_NO = " . $_SESSION['gl_no']);
        ...
        if ($dep_count > 0) {
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <fieldset>
                    <legend>Recovery info</legend>
                    <div style="max-height: 300px; overflow-y: auto">
                        <table class="table table-bordered">
                            <?php
                            $get_rec_info = new Database;
                            $get_rec_info->query("select * from th_share_trans where GL_NO = " . $_SESSION['gl_no'] . " and TRAN_TYPE = 'R' order by TRANS_DATE DESC");
                           // print_r($get_rec_info);
                            ...
                            if ($rec_count > 0) {
                                ...
                                foreach ($rec_info as $rec_info) {
                                    ?>
                                    <tr>
                                        <td><?php echo date('d-m-Y', strtotime($rec_info['TRANS_DATE'])) ?></td><td><?php echo $rec_info['AMOUNT'] ?></td>
                                    </tr>
                                    <?php
                                }
                            } else {
