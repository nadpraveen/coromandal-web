        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
            ...
            <fieldset>
                ...
                <table class="table table-bordered" id="info_tbl">
                    ...
                    $get_loan_info->query("select * from th_mv_loan_master where GL_NO = " . $_SESSION['gl_no'] . " and LOAN_STATUS = 'R'");
                ...
                <fieldset>
                    ...
                    <div style="max-height: 300px; overflow-y: auto">
                        <table class="table table-bordered">
                            ...
                            $get_rec_info->query("select * from th_mv_loan_trans where LOAN_NO = " . $info['LOAN_NO'] . " and TRAN_TYPE = 'R' order by TRANS_DATE DESC");
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <table class="table table-bordered">
                                ...
                                <?php
                                $loan_list_query = "select * from th_mv_loan_master where GL_NO = " . $_SESSION['gl_no'] . " ORDER BY `DATE_OF_SANCTION` DESC";
